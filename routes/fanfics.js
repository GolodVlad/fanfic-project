...
cloudinary.config({
  ...
  api_key: '677565293862925',
  api_secret: 'MDuDdnoOSig9Lv1e9STNfhSx07c'
});
...
module.exports = (router) => {
    ...
    Fanfic.find({}, (err, fanfics) => {
      if (err) {
        ...
        if (!fanfics) {
          ...
          res.json({ success: true, fanfics });
        }
      }
    }).sort({ '_id': -1 });
  })

  router.get('/userFanfics/', (req, res) => {
  ...
  router.get('/singleFanfic/', (req, res) => {
